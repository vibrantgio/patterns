...
require (
	...
	github.com/vibrantgio/components v1.4.0
	github.com/vibrantgio/effects v0.3.0
	github.com/vibrantgio/mvu v1.1.0
	github.com/vibrantgio/mvu/desktop v1.1.0
	github.com/vibrantgio/theme v1.4.0
...
require (
	...
	github.com/vibrantgio/svg v0.1.1 // indirect
